...
struct MockData {
    ...
    static let events = [
        ...
        Event(title: "CCF Beach Trip", image: "background3", time: "10am", createdBy: "Kane", eventDate: "10/08/2021", location: "Kane's House", publishDate: "09/07/2021", series: nil, cost: 75, registerURL: "fsuccf.com/beach", description: "This is going to be a weekend trip to the beach. It's a time to get to k now one another.")
    ]
